                ...
                out.print("</div>"); %>
					...
					<div class="data">
						<%
							...
							%>
							<tr> <td><%= rs2.getString("name") %></td> <td><%= rs.getDouble("bidprice") %></td><td><%= rs.getTimestamp("bidTime") %></td></tr>
							<% }	%>
							</table>
					...
					<li>Start selling
                     <div class="data">
                    <h4>Please fill out the following details to start selling.</h4>
                        Name <br><input id="name" type="text"> <br>
                        CategoryID<br> <input id="categoryid"  name="userid" type="text"> <br>
                        Buy It Now Price<br> <input  id="buyitnowprice" name="cateid" type="text"> <br>
                        Description <br> <textarea id="description" rows="10" cols="80" id="description"> </textarea><br>
						<form action="addimage.jsp" method="post" enctype="multipart/form-data">
						Add image <input  id="image"  type="file" name="file" size="50">
